...
const Calculator: React.FC = () => {
  ...
  const TabButton = ({ tab, label }: { tab: Tab, label: string}) => (
    <button
        ...
        className={`px-4 py-2 text-sm md:text-base font-medium rounded-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-primary-400 ${
        activeTab === tab 
  ...
  return (
    <div className="max-w-4xl mx-auto">
        <div className="bg-card rounded-2xl shadow-2xl shadow-black/30 p-4 sm:p-6 md:p-8 border border-primary-800">
            <div className="mb-6 flex justify-center bg-black/20 rounded-lg p-1.5 space-x-2">
