...
const AboutPage: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="bg-card border border-primary-900 p-6 rounded-lg">
                <h2 className="text-3xl font-bold text-white border-b-2 border-primary-800 pb-2 mb-4">Our <span className="text-custom-gradient">Mission</span></h2>
             ...
             <section>
                <h2 className="text-3xl font-bold text-white border-b-2 border-primary-800 pb-2 mb-4">Key <span className="text-custom-gradient">Features</span></h2>
