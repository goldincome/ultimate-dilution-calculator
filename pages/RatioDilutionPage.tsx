    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-card rounded-2xl shadow-2xl shadow-black/30 p-4 sm:p-6 md:p-8 border border-primary-800">
                   <RatioCalculator />
                </div>
            </div>
            ...
            <section className="mt-16 max-w-4xl mx-auto space-y-8">
                <div>
                    <h2 className="text-3xl font-bold text-white border-b-2 border-primary-800 pb-2 mb-4">Understanding <span className="text-custom-gradient">Ratio Dilutions</span></h2>
                 ...
                 <div>
                    <h2 className="text-3xl font-bold text-white border-b-2 border-primary-800 pb-2 mb-4">How to Use This <span className="text-custom-gradient">Calculator</span></h2>
