    ...
    return (
        <>
            ...
            <section className="mt-16 max-w-4xl mx-auto space-y-8">
                <div>
                    <h2 className="text-3xl font-bold text-white border-b-2 border-primary-800 pb-2 mb-4">What is a <span className="text-custom-gradient">Serial Dilution?</span></h2>
