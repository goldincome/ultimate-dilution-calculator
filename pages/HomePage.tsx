        ...
        <>
            <div className="text-center mb-12">
                ...
                <div className="mt-4 text-sm">
                    <span className="inline-block bg-primary-950 text-primary-300 rounded-full px-4 py-1.5 font-medium border border-primary-700">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-card rounded-2xl shadow-2xl shadow-black/30 p-4 sm:p-6 md:p-8 border border-primary-800">
                    <h2 className="text-2xl font-bold text-center text-white mb-6">Standard Dilution (C₁V₁ = C₂V₂)</h2>
                    <StandardCalculator />
                </div>
            </div>
